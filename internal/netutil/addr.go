...
func CloudflaredURL() string {
	...
	// curl is available on Linux and modern Windows 10/11
	...
	// Fallback: journalctl — Linux only
	if runtime.GOOS != "windows" {
		return cloudflaredFromJournalctl()
	}
	return ""
}
...
func cloudflaredFromJournalctl() string {
